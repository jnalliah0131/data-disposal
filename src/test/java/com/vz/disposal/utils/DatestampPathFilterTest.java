...
public class DatestampPathFilterTest {
    ...
    public Object[][] acceptCases() {
        ...
        return new Object[][] {
                {ChronoUnit.DAYS, 30, 10, formatter, mockStatus(new Path("/somepath/2017-05-23/a")), false},
                {ChronoUnit.DAYS, 30, 10, formatter, mockStatus(new Path("/somepath/2017-05-23")), false},
                {ChronoUnit.DAYS, 30, 10, formatter, mockStatus(new Path("/somepath/20170523")), true},
                {ChronoUnit.DAYS, 30, 10, formatter, mockStatus(new Path("/somepath/20171510")), false},
